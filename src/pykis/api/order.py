...
class OrderAPI:
    ...
    국내 주식(KOSPI/KOSDAQ/ETF)의 주문을 생성/취소/조회합니다.
    """
    ...
    def __init__(self, http, account_no: str, is_paper: bool):
        ...
        # 계좌번호 분리 (CANO: 앞 8자리, ACNT_PRDT_CD: 뒤 2자리)
    ...
    def fetch_open_orders(self) -> List[Order]:
        ...
        for item in data.get("output", []):
            ...
            orders.append(Order(
                ...
                side=side,
                type=OrderType.LIMIT,  # 미체결 조회에서는 기본 지정가
                status=OrderStatus.OPEN,
